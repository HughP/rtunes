...
(function($, undefined) {
	...
	$.jPlayer.prototype = {
		...
		options: { // Instanced in $.jPlayer() constructor
			...
			volume: (sysVolume) ? sysVolume : 0.8, // The volume. Number 0 to 1.
			muted: false,
...
*/
		...
		_init: function() {
			...
			this.internal.audio = $.extend({}, {
				id: 'audio',//this.options.idPrefix + "_audio_" + this.count,
				jq: undefined
			});
		...
		_addHtmlEventListeners: function(mediaElement, entity) {
			...
			mediaElement.addEventListener("volumechange", function() {
				if(entity.gate) {
					...
					sysVolume = mediaElement.volume;
					rt.cookies.set('sysVolume', sysVolume, 60, '/', '', '' );
				}
			}, false);
		...
		_updateVolume: function(v) {
			...
			try{
				Ext.getCmp('rtunes-global-volume').setValue(v*100);
			}catch(e){}
		},
